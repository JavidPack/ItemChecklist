...
namespace ItemChecklist
{
	...
	internal static class MagicStorageExtraIntegration
	{
		...
		private static Point16 previousStorageAccess = new Point16(-1, -1);
		...
		{
			MagicStorage = ModLoader.GetMod("MagicStorageExtra");
			if (Enabled)
